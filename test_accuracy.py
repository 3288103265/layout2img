...
class CocoSceneGraphDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return image, objs, boxes, filename, HH, WW## , b_map #, None # obj_masks #, obj_masks # , b_map # masks # , triples
...
def main(args):
    ...
    print(args.num_img)
    with tqdm(total=dataloader.__len__()) as pbar:
        for idx, data in enumerate(dataloader):
            real_images, label, bbox, filename, HH, WW = data
            ...
            # print(filename)
            fake_images_uint = imresize(fake_images_uint, (HH.item(), WW.item()))
